...
| AZURE_CLOUD_ENVIRONMENT | Azure Authority Host Service url that will be used. This is a optional parameter and will default to **AzurePublicCloud** if not specified. <hr>**AzurePublicCloud** <br> https://management.azure.com/ <br> **AzureChinaCloud** <br> https://management.chinacloudapi.cn/ <br> **AzureGermanCloud** <br> https://management.microsoftazure.de/ <br> **AzureUSGovernment** <br>  https://management.usgovcloudapi.net/
